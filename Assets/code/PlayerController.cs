...
public class PlayerController : MonoBehaviour
{
    ...
    void MovePlayer()
    {
        if (true)
        {
            ...
            if (targetRotation.y > 270.0f && targetRotation.y < 361f) targetRotation.y = 0.0f;
            if(targetRotation.y < 0f) targetRotation.y = 270.0f;
    ...
    public void RotateLeft() {
        if (AtRest) targetRotation -= Vector3.up * 90.0f;
       }
